...
\footnote{Several of the Dread Knight's class features and available spells refer to ``Cursed'' targets. A Cursed target is any creature affected by the Dread Knight's Curse ability, or any creature affected by one of the following spells: \nameref{Spell:Bane}, \nameref{Spell:BestowCurse},\nameref{Spell:Blindness}, \nameref{Spell:CrushingOnsetOfAge}, \nameref{Spell:CursedBlade}, \nameref{Spell:DenialOfDeathsEmbrace}, \nameref{Spell:Fear}, \nameref{Spell:InexorableOnsetOfDeath} and \nameref{Spell:Pox}.}
