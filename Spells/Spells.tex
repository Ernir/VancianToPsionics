...
Your can search for both general items, in which case you locate the nearest one of its kind if more than one is within range, or for a certain or unique item.
