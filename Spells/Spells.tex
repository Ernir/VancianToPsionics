...
\subsubsection{Fear}
\label{Spell:Fear}
Necromancy [\nameref{sec:Curses}, Fear, Mind-Affecting]
...
\paragraph{Augment:} If you spend 2 additional spell points, the spell can free victims from certain powerful spells (particularly enchantments and transmutations) in addition to curses.
