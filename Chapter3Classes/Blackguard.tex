...
You gain the service of a hellish animal. See the \nameref{sec:FiendishMount} creature description. You must be a 5th-level Blackguard to select this gift.
...
You are the dark powers' chosen instrument of doom. Once per day, you can use \nameref{Spell:InsectPlague} as a spell-like ability. Caster level equals the sum of your Blackguard level and your Ex-Paladin level.
