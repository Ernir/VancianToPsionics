...
\emph{Version:} \\
Beta 1.12b \href{https://github.com/Ernir/VancianToPsionics/releases}{(See all versions)}\\
\end{flushright}
\end{titlepage}
...
\input{Chapter1SpellcastingSystem/_Chapter1SpellcastingSystem.tex} \newpage
...
\input{Chapter2Races/_Chapter2Races.tex} \newpage
...
\input{Chapter5Feats/_Chapter5Feats.tex}
...
\input{Chapter6Spells/_Chapter6Spells.tex}\newpage
...
\input{Chapter7Creatures/_Chapter7Creatures.tex}\newpage
...
\input{Chapter8Items/_Chapter8Items.tex}\newpage
...
\input{Chapter9New/_Chapter9New.tex}\newpage
\part{End notes}
\input{Chapter10EndNotes/_Chapter10EndNotes.tex}
\end{multicols}
\end{document}
