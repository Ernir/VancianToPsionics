...
\begin{list}{\labelitemi}{\leftmargin=1em}
 ...
 \item The players in my current (\today, 2012) campaign, who have actually bothered with reading some of this crap
 \item and everyone else who has commented no the system and listened to me prattle on about it as it was coming up.
\end{list}
\subsection{Version history}
\begin{list}{\labelitemi}{\leftmargin=1em}
 \item Beta 1.11. High elf race added, and racial descriptions expanded. Mystic Theurge class added.
