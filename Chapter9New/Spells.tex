...
The creature gains the ability to adapt to underwater, extremely hot, extremely cold, or airless environments, allowing him to survive as if he were a creature native to that environment. 
...
\subsubsection{Bands of Air}
\label{Spell:BandsOfAir}
Evocation [Air]
\\ \textbf{Level:} Air Specialization 3
\\ \textbf{Components:} V, S
\\ \textbf{Casting Time:} 1 standard action
\\ \textbf{Range:} Medium (100 ft. + 10 ft./level)
\\ \textbf{Target:} One creature
\\ \textbf{Duration:} Concentration + 1 round/level; see text
\\ \textbf{Saving Throw:} Reflex negates
\\ \textbf{Spell Resistance:} Yes
\\ \textbf{Spell Points:} 5

\emph{The air itself solidifies to form an invisible trap}

The subject must succeed on a Reflex save or be \emph{immobilized}.

The subject remains \emph{immobilized} for as long as you concentrate. Should you cease concentrating, the subject may attempt to end the spell as a full-round action, either by breaking the bands (Strength DC 15) or slipping free (Escape Artist DC 15).

\paragraph{Augment:} For every additional spell point you spend, the Strength or Escape Artist DC to escape increases by 1.
...
\subsubsection{Frozen Slick}
\label{Spell:FrozenSlick}
Evocation [Cold]
\\ \textbf{Level:} Ice Specialization 1
\\ \textbf{Components:} V, S
\\ \textbf{Casting Time:} 1 standard action
\\ \textbf{Range:} Close (25 ft. + 5 ft./2 levels) 
\\ \textbf{Area:} A 10-ft. square of surface
\\ \textbf{Duration:} 1 round/level (D)
\\ \textbf{Saving Throw:} See spell text
\\ \textbf{Spell Resistance:} No
\\ \textbf{Spell Points:} 1

\emph{You cover the ground with a sheet of ice, clear as the finest glass.} 

Any creature in the area when this spell is cast must make a successful Reflex save or fall. This save is repeated on your turn each round that the creature remains within the area.  A creature can walk within or through the slick area at half normal speed with a DC 10 Balance check. Failure means it can't move that round (and must then make a Reflex save or fall), while failure by 5 or more means it falls (see the Balance skill for details).

The spell has a particularly strong effect when cast on the surface of water, freezing its topmost layer. A creature of medium size or smaller can move across a surface of water so frozen, provided they succeed on the appropriate Balance check. The DC of the balance check increases by 5 if the sheet is not solidly anchored. Larger creatures trying to cross immediately break up the ice and sink through.

Each 5' square of the ice formed by this spell has 3 hit points and hardness 5, break DC 15. A square of ice that has been broken up loses its slippery quality, or in the case of ice floating on the surface of water, becomes non-traversible again.

\paragraph{Augment:} For every 2 additional spell points you spend, you can cover an additional 10' square with ice. Each square must be adjacent to another square.
...
\paragraph{Augment:} For every additional spell point spent, the attacker loses an additional gold piece per hit.
...
An effect that removes a powerful curse (See \nameref{sec:RemovingACurse}) can restore a transmuted creature.
...
\subsection{'L' Spells}
\subsubsection{Lash of Morals}
\label{Spell:LashOfMorals}
Transmutation [Good]
\\ \textbf{Level:} Paladin 3
\\ \textbf{Components:} V
\\ \textbf{Casting Time:} 1 standard action
...
\emph{Your weapon not only threatens evildoers' flesh, but makes them feel the pain of their sins as well.}

For the duration of this spell, every time you successfully deal damage to a non-good creature with a weapon, it takes one point of Charisma damage. 

A critical hit does not multiply the Charisma damage. A creature under the influence of an \nameref{Spell:AlignedProtection} spell or similar abjuration keyed to protect against Good is immune to the Charisma damage.
...
\subsubsection{Mage Fist}
\label{Spell:MageFist}
Transmutation
\\ \textbf{Level:} Force Specialization 2
\\ \textbf{Components:} V, S
\\ \textbf{Casting Time:} 1 standard action
\\ \textbf{Range:} Close (25 ft. + 5 ft./2 levels)
\\ \textbf{Target:} One object or one creature
\\ \textbf{Duration:} Instantaneous
\\ \textbf{Saving Throw:} None
\\ \textbf{Spell Resistance:} Yes (object)
\\ \textbf{Spell Points:} 3

\emph{With a contemptuous flick of the mage's hand, the guard's feet went out from under him.}
...
\paragraph{Augment:}
For every 4 additional spell points you spend, the force is treated as a creature one size category larger, to a maximum of colossal.

\subsubsection{Magewind}
\label{Spell:Magewind}
Evocation [Air]
\\ \textbf{Level:} Air Specialization 1
\\ \textbf{Components:} V, S
\\ \textbf{Casting Time:} 1 minute
\\ \textbf{Range:} 1 mile
\\ \textbf{Area:} 1-mile radius sphere, centered on the caster
\\ \textbf{Duration:} Concentration + 1 minute
\\ \textbf{Saving Throw:} None
\\ \textbf{Spell Resistance:} No
\\ \textbf{Spell Points:} 1

\emph{The mage closed her eyes in concentration, willing the wind to fill the sails.}

You invoke a gentle change in the wind in the spell's affected area. The change gradually takes effect one minute after the spells's completion.

The effect's area is a sphere, centered on the caster. This skill can only be used outdoors. The wind does not have a supernatural ability to penetrate shelter.

At the time of casting, the caster decides how the wind will be affected. They have a choice of changing the wind's direction, or stopping the wind altogether. Only a \emph{Light Wind} or a \emph{Moderate Wind} can be invoked or affected by this Ritual, not winds of greater strength. Attempting to use this spell during a \emph{Strong Wind} or stronger has no effect.

If two or more casters attempt to control the wind in conflicting ways, normal wind conditions apply in the overlapping area.

\paragraph{Augment:} This spell can be augmented in one of the following ways:
\begin{itemize}
 \item If you spend 4 additional spell points, this spell can invoke or affect a \emph{Strong Wind}.
 \item If you spend 8 additional spell points, this spell can invoke or affect a \emph{Severe Wind}.
\end{itemize}
...
This part of the spell is permanent unless dismissed by the caster or the curse is broken (See: \nameref{sec:RemovingACurse}), persisting even if the Constitution damage is healed.
...
\subsubsection{Regal Bearing}
\label{Spell:RegalBearing}
Transmutation
\\ \textbf{Level:} Paladin 2
\\ \textbf{Components:} V, S
\\ \textbf{Casting Time:} 1 standard action
\\ \textbf{Range:} Personal
\\ \textbf{Target:} You
\\ \textbf{Duration:} 10 min./level (D); see text
\\ \textbf{Spell Points:} 3

\emph{Your back appears straighter and your teeth whiter.}

You gain a +4 enhancement bonus on Bluff and Diplomacy checks, as well as on Disguise checks made to appear as someone of a higher social status.

Once you have succeeded on using one of the bonused skill checks against a creature, you can discharge the spell as a standard action to target the creature with a \nameref{Spell:Command} effect, which functions identically to an unaugmented version of the spell. Doing this causes the Regal Bearing spell to end, though the Command effect continues to run its course for one round as normal. The save DC of the Command effect is equal to the save DC of the Regal Bearing spell.

\paragraph{Augment:} For every two additional spell points you spend, the skill check bonuses granted by this spell increase by 1.
...
The effect hedges out evil outsiders, undead creatures, natives of the plane of shadow, and creatures who take damage or penalties from bright light or sunlight. 
When a creature of the listed types attempts to penetrate the barrier, it takes 2d6 points of damage, and must make a Will save or fail to cross, its movement stopped.
...
\begin{enumerate}
 ...
 \item For every 2 additional spell points you spend, the spell deals an additional 1d6 points of damage on an attempted crossing.
...
\subsubsection{Spike Gravity}
\label{Spell:SpikeGravity}
Transmutation [Earth]
\\ \textbf{Level:} Gravity Specialization 4
\\ \textbf{Components:} V, S
\\ \textbf{Casting Time:} 1 standard action
\\ \textbf{Range:} Medium (100 ft. + 10 ft./level)
\\ \textbf{Effect:} 20-ft. radius cylinder emanation 120-ft. high
\\ \textbf{Duration:} 1 round/level
\\ \textbf{Saving Throw:} Fortitude partial; see text
\\ \textbf{Spell Resistance:} Yes
\\ \textbf{Spell Points:} 5

\emph{With a decisive motion, you bring your fist down, and the troops tumble to the ground.}
...
\subsubsection{Strike of Law}
\label{Spell:StrikeOfLaw}
Transmutation [Law]
\\ \textbf{Level:} Paladin 4
\\ \textbf{Components:} V
\\ \textbf{Casting Time:} 1 swift action
\\ \textbf{Range:} Touch
\\ \textbf{Targets:} One melee weapon
...
\emph{Reciting the villain's crimes, you command him to stop in the name of Law.}

A creature struck by the weapon must succeed on a fortitude save or be \emph{paralyzed} for one round.
Spell resistance applies against the paralysis effect.
The weapon remains so enhanced only until the end of the current turn. 
If the weapon does not hit a creature before the end of the turn, the spell drains away harmlessly.
...
For the duration of this spell, every time you successfully deal damage to a creature with a weapon, it takes one point of Constitution damage. Creatures immune to critical hits are immune to the Constitution damage. A critical hit does not multiply the Constitution damage. This effect stacks with the effect of a Wounding weapon.
