...
\begin{enumerate}
 ...
 Its bite and talon attacks (if existant) have their base damage dice increased by one step.
...
\end{enumerate}
\subsubsection{Form of the Carnivore}
...
rushed or tripped when standing on the ground. Its land speed changes to 40'.
However, the form has no hands, preventing the subject from using weapons and items requiring fine manipulation (although it can use its feet to hold things that can be easily gripped). It cannot provide somatic components.
...
\begin{enumerate}
 ...
 \item If you spend 12 additional spell points, the subjects's size becomes gargantuan when casting the spell, and its strength score changes to 34.
...
\begin{enumerate}
 ...
 The bite, claw, wing and tail (if the subject havs it) attacks have their base damage dice increased by one step.
...
\\ You gain immunity to electicity and fire.
...
\\ It gains a bite attack that deals 1d6 points of damage + 1 1/2 times your strength modifier, which the subject's primary natural attack.
